...
/* harmony import */ var _model_films_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model-films.js */ "./src/components/model-films.js");
/* harmony import */ var _model_comments_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model-comments.js */ "./src/components/model-comments.js");
...
class API {
  ...
  getFilms() {
    return this._load({url: `movies/`})
      .then(toJSON)
      .then(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseTasks);
  }

  getComments(id) {
    return this._load({url: `comments/${id}`})
      .then(toJSON)
      .then(_model_comments_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseTasks);
  }

  toRAWComment(data) {
    return {
      "comment": data.text,
      "date": moment__WEBPACK_IMPORTED_MODULE_2___default()(data.date).format(),
      "emotion": data.image,
    };
  }
  ...
  updateFilm({id, data}) {
    return this._load({
      ...
      .then(toJSON)
      .then(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseTask);
  }
...
class Comments extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    return `<li class="film-details__comment">
      ...
      <div>
        ...
        <p class="film-details__comment-info">
          ...
          <span class="film-details__comment-day">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).startOf(`day`).fromNow()}</span>
...
/***/ "./src/components/extra-container.js":
/*!*******************************************!*\
  !*** ./src/components/extra-container.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ExtraContainer; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");


class ExtraContainer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
          ...
          <div class="film-details__info">
            ...
            <table class="film-details__table">
              ...
              <tr class="film-details__row">
                ...
                <td class="film-details__cell">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._relaeseDate).format(`DD MMMM YYYY`)}</td>
              </tr>
              <tr class="film-details__row">
    ...
    return `<article class="film-card">
     ...
     <p class="film-card__rating">${this._rating}</p>
      <p class="film-card__info">
        <span class="film-card__year">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format(`YYYY`)}</span>
...
/***/ "./src/components/model-comments.js":
/*!******************************************!*\
  !*** ./src/components/model-comments.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ModelComments; });
class ModelComments {
  constructor(data) {
    this.id = data[`id`];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ModelFilms; });
class ModelFilms {
  constructor(data) {
    this.id = data[`id`];
...
/***/ "./src/components/on-data-change.js":
/*!******************************************!*\
  !*** ./src/components/on-data-change.js ***!
  \******************************************/
/*! exports provided: onDataChange */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onDataChange", function() { return onDataChange; });
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../main */ "./src/main.js");
/* harmony import */ var _controllers_comments_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../controllers/comments-controller */ "./src/controllers/comments-controller.js");



const onDataChange = (actionType, update, old, unit, evt, pageController) => {
  const shake = (element) => {
  ...
  switch (actionType) {
    case `update`:
      _main__WEBPACK_IMPORTED_MODULE_0__["api"].updateFilm({
        id: update.id,
        data: update
      }).then(() => {
        _main__WEBPACK_IMPORTED_MODULE_0__["api"].getFilms().then((filmss) => {
          const id = update.id;
    ...
    case `updateRating`:
      ...
      break;
    case `delete`:
      _main__WEBPACK_IMPORTED_MODULE_0__["api"].deleteComment({
        id: update,
      }).then(() => {
        document.querySelector(`.film-details__comments-list`).innerHTML = ``;
        _main__WEBPACK_IMPORTED_MODULE_0__["api"].getComments(unit)
          .then((comments) => {
            const body = document.querySelector(`body`);
            const commentsController = new _controllers_comments_controller__WEBPACK_IMPORTED_MODULE_1__["default"](comments, body, onDataChange, unit);
      ...
      break;
    case `add`:
      _main__WEBPACK_IMPORTED_MODULE_0__["api"].createComment({
        id: update,
        data: old,
      }).then(() => {
...
class Profile extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(rank) {
    super();
    this._rank = rank;
  }
...
class Rating extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({title, nameImage, ratingFilm}) {
    super();
    this._title = title;
    this._nameImage = nameImage;
    this._ratingFilm = ratingFilm;
  }
    ...
    <div class="film-details__user-score">
      ...
      <section class="film-details__user-rating-inner">
        ...
        <div class="film-details__user-rating-score">
          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="1" id="rating-1" ${this._ratingFilm === 1 ? `checked` : ``}>
          <label class="film-details__user-rating-label" for="rating-1">1</label>

          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="2" id="rating-2" ${this._ratingFilm === 2 ? `checked` : ``}>
          <label class="film-details__user-rating-label" for="rating-2">2</label>

          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="3" id="rating-3" ${this._ratingFilm === 3 ? `checked` : ``}>
          <label class="film-details__user-rating-label" for="rating-3">3</label>

          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="4" id="rating-4" ${this._ratingFilm === 4 ? `checked` : ``}>
          <label class="film-details__user-rating-label" for="rating-4">4</label>

          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="5" id="rating-5" ${this._ratingFilm === 5 ? `checked` : ``}>
          <label class="film-details__user-rating-label" for="rating-5">5</label>

          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="6" id="rating-6" ${this._ratingFilm === 6 ? `checked` : ``}>
          <label class="film-details__user-rating-label" for="rating-6">6</label>

          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="7" id="rating-7" ${this._ratingFilm === 7 ? `checked` : ``}>
          <label class="film-details__user-rating-label" for="rating-7">7</label>

          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="8" id="rating-8" ${this._ratingFilm === 8 ? `checked` : ``}>
          <label class="film-details__user-rating-label" for="rating-8">8</label>

          <input type="radio" name="score" class="film-details__user-rating-input visually-hidden" value="9" id="rating-9" ${this._ratingFilm === 9 ? `checked` : ``}>
...
/***/ "./src/components/result-count.js":
/*!****************************************!*\
  !*** ./src/components/result-count.js ***!
  \****************************************/
/*! exports provided: default */
...
class ResultCount extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(count) {
    super();
    this._count = count;
  }
...
/***/ "./src/components/section-films.js":
/*!*****************************************!*\
  !*** ./src/components/section-films.js ***!
  \*****************************************/
/*! exports provided: default */
...
class SectionFilms extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class StatisticChart extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StatisticText; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");


class StatisticText extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class Statistic extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(rank) {
    super();
    this._rank = rank;
  }
...
/*!*********************************!*\
  !*** ./src/components/utils.js ***!
  \*********************************/
/*! exports provided: createElement, render, unrender */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/utils.js */ "./src/components/utils.js");
...
class CommentsController {
  ...
  _renderComment(comments) {
    const comment = new _components_comments_js__WEBPACK_IMPORTED_MODULE_0__["default"](comments);
    ...
    Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._commentsList, comment.getElement());
  }
...
/* harmony import */ var _comments_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./comments-controller.js */ "./src/controllers/comments-controller.js");
...
class MovieController {
  constructor(container, containerPopup, films, onDataChange, onChangeView, onDataChangeMain, radio) {
    ...
    this._containerPopup = containerPopup;
    this._films = films;
    this._film = new _components_film_js__WEBPACK_IMPORTED_MODULE_1__["default"](films);
    this._filmDetails = new _components_film_details_js__WEBPACK_IMPORTED_MODULE_2__["default"](this._films);
    this._rating = new _components_rating_js__WEBPACK_IMPORTED_MODULE_3__["default"](this._films);
  ...
  init() {
    ...
    const onEscKeyDown = (evt) => {
      if (evt.key === `Escape` || evt.key === `Esc`) {
        ...
        Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_0__["unrender"])(this._filmDetails.getElement());
    ...
    this._film.getElement()
      .addEventListener(`click`, () => {
        this._onChangeView();
        Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._containerPopup, this._filmDetails.getElement());
        _main_js__WEBPACK_IMPORTED_MODULE_5__["api"].getComments(this._films.id).then((comments) => {
          const commentsController = new _comments_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](comments, this._containerPopup, this._onDataChangeMain, this._films.id);
          commentsController.init();
        ...
        if (this._films.isHistory) {
          Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(getContainer(), this._rating.getElement());
    ...
    Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._film.getElement());
  }
...
/* harmony import */ var _page_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./page-controller */ "./src/controllers/page-controller.js");
/* harmony import */ var _components_on_data_change__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/on-data-change */ "./src/components/on-data-change.js");
...
class NavigationController {
  ...
  _renderOtherFilms(array, categoryFocus) {
    const navOnDateChange = (actionType, update, old, unit, evt) => {
      return Object(_components_on_data_change__WEBPACK_IMPORTED_MODULE_3__["onDataChange"])(actionType, update, old, unit, evt, page);
    };

    const page = new _page_controller__WEBPACK_IMPORTED_MODULE_2__["default"](this._body, this._main, array, false, navOnDateChange, categoryFocus);
    page.initNav();
  }
  ...
  init() {
    _main__WEBPACK_IMPORTED_MODULE_1__["api"].getFilms().then((films) => {
      const nav = new _components_navigation__WEBPACK_IMPORTED_MODULE_0__["default"](this._scoreFilms(`isWatchlist`, films).length, this._scoreFilms(`isHistory`, films).length, this._scoreFilms(`isFavorites`, films).length);
...
/* harmony import */ var _movie_controller_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./movie-controller.js */ "./src/controllers/movie-controller.js");
...
/* harmony import */ var _components_extra_container_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/extra-container.js */ "./src/components/extra-container.js");
...
/* harmony import */ var _statistic_controller_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./statistic-controller.js */ "./src/controllers/statistic-controller.js");
/* harmony import */ var _navigation_controller_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./navigation-controller.js */ "./src/controllers/navigation-controller.js");
...
class PageController {
  constructor(containerBody, main, films, radio, onDataChange, categoryFocus) {
    ...
    this._showMore = new _components_show_more_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._sort = new _components_sort_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._filmsContainer = new _components_films_container__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._filmsContainerTopRated = new _components_extra_container_js__WEBPACK_IMPORTED_MODULE_5__["default"](`top`, `Top rated`);
    this._filmsContainerMostCommented = new _components_extra_container_js__WEBPACK_IMPORTED_MODULE_5__["default"](`bottom`, `Most commented`);
  ...
  getContainerFilms() {
    const sectionFilms = this._main.querySelector(`.films`);
    Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_2__["render"])(sectionFilms, this._filmsContainer.getElement());
  }
  ...
  _renderFilm(container, films, radio) {
    const movieController = new _movie_controller_js__WEBPACK_IMPORTED_MODULE_0__["default"](container, this._containerBody, films, this._onDataChange, this._onChangeView, this.onDataChange, radio);
  ...
  _renderFilmsTopRated() {
    ...
    if (filmsTopRated.length > 0) {
      ...
      container.innerHTML = ``;
      Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._main.querySelector(`.films`), this._filmsContainerTopRated.getElement());
  ...
  _renderFilmsMostCommented() {
    ...
    if (filmsMostCommented.length !== 0) {
      ...
      container.innerHTML = ``;
      Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._main.querySelector(`.films`), this._filmsContainerMostCommented.getElement());
  ...
  renderLoadMore() {
    ...
    Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_2__["render"])(containerButton, this._showMore.getElement());
    this._showMore.getElement().addEventListener(`click`, makeLoadMore);
  }

  unrenderLoadMore() {
    Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_2__["unrender"])(this._showMore.getElement());
  }

  _renderNavigation(categoryFocus) {
    const nav = new _navigation_controller_js__WEBPACK_IMPORTED_MODULE_8__["default"](this._main, this._containerBody, this._films, categoryFocus);
    nav.init();
  }
  ...
  _renderProfile() {
    const profile = new _components_profile_js__WEBPACK_IMPORTED_MODULE_6__["default"](this._getRank());
    Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._containerBody.querySelector(`header`), profile.getElement());
  }
  ...
  _renderStatistic() {
    ...
    const statistic = new _statistic_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"](this._main, filmsHistory(), this._getRank());
    statistic.init();
  }
...
/* harmony import */ var _components_utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/utils.js */ "./src/components/utils.js");
/* harmony import */ var _components_section_films_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/section-films.js */ "./src/components/section-films.js");
/* harmony import */ var _components_result_count_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/result-count.js */ "./src/components/result-count.js");
/* harmony import */ var _page_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./page-controller.js */ "./src/controllers/page-controller.js");
/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../main.js */ "./src/main.js");
/* harmony import */ var _components_on_data_change_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/on-data-change.js */ "./src/components/on-data-change.js");
...
class SearchController {
  ...
  _renderSearch() {
    const search = new _components_search_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    const body = document.querySelector(`body`);

    const searchFilms = () => {
      _main_js__WEBPACK_IMPORTED_MODULE_5__["api"].getFilms().then((films) => {
        const scanRenderOnDateChange = (actionType, update, old, unit, evt) => {
          return Object(_components_on_data_change_js__WEBPACK_IMPORTED_MODULE_6__["onDataChange"])(actionType, update, old, unit, evt, page);
        };

        const textariaValue = search.getElement().querySelector(`.search__field`).value.trim();
        const arrayResult = [];
        const searchResult = new _components_section_films_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
        Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._containerResult, searchResult.getElement());

        const page = new _page_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](body, this._containerResult, arrayResult, true, scanRenderOnDateChange, `all`);
        for (const value of films) {
        ...
        const resultCount = new _components_result_count_js__WEBPACK_IMPORTED_MODULE_3__["default"](arrayResult.length);

        if (arrayResult.length !== 0) {
          Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._containerResult, resultCount.getElement());
          Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._containerResult, searchResult.getElement());
          page.renderBoard();
    ...
    const renderBack = () => {
      ...
      _main_js__WEBPACK_IMPORTED_MODULE_5__["api"].getFilms().then((films) => {
        const scanRenderBackOnDateChange = (actionType, update, old, unit, evt) => {
          return Object(_components_on_data_change_js__WEBPACK_IMPORTED_MODULE_6__["onDataChange"])(actionType, update, old, unit, evt, pageController);
        };

        const searchResult = new _components_section_films_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
        const pageController = new _page_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](body, this._containerResult, films, false, scanRenderBackOnDateChange, `all`);
        Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._containerResult, searchResult.getElement());
    ...
    Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, search.getElement());
  }
}
...
/* harmony import */ var _components_statistic_chart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/statistic-chart */ "./src/components/statistic-chart.js");
...
/* harmony import */ var _components_statistic_text__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/statistic-text */ "./src/components/statistic-text.js");
...
class StatisticController {
  constructor(container, films, rank) {
    ...
    this._statistic = new _components_statistic__WEBPACK_IMPORTED_MODULE_0__["default"](this._rank);
  }
  ...
  _getArrayFilms(number) {
    ...
    Object(_components_utils__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._statistic.getElement());
    const newArrayFilms = () => {
      const arr = [];
      for (const value of this._films) {
  ...
  _renderStatisticText(films) {
    ...
    if (films.length > 0) {
      statisticText = new _components_statistic_text__WEBPACK_IMPORTED_MODULE_3__["default"](statisticWatched, statisticDuration(), statisticGenre);
    } else {
      statisticText = new _components_statistic_text__WEBPACK_IMPORTED_MODULE_3__["default"](0, 0, `-`);
    }

    Object(_components_utils__WEBPACK_IMPORTED_MODULE_2__["render"])(this._statistic.getElement(), statisticText.getElement());
  }

  _renderStatisticDiagram(films) {
    if (films.length > 0) {
      const containerStatisticChart = new _components_statistic_chart__WEBPACK_IMPORTED_MODULE_1__["default"]();
      Object(_components_utils__WEBPACK_IMPORTED_MODULE_2__["render"])(this._statistic.getElement(), containerStatisticChart.getElement());
      ...
      const getGenresChart = () => {
        const genresChart = new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(container, {
...
/* harmony import */ var _components_utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/utils.js */ "./src/components/utils.js");
/* harmony import */ var _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers/page-controller.js */ "./src/controllers/page-controller.js");
/* harmony import */ var _controllers_search_controller_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/search-controller.js */ "./src/controllers/search-controller.js");
/* harmony import */ var _components_section_films_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/section-films.js */ "./src/components/section-films.js");
...
/* harmony import */ var _components_on_data_change_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/on-data-change.js */ "./src/components/on-data-change.js");
...
const api = new _components_api_js__WEBPACK_IMPORTED_MODULE_4__["default"]({endPoint: END_POINT, authorization: AUTHORIZATION});
const header = document.querySelector(`.header`);
const main = document.querySelector(`.main`);
const footerCount = document.querySelector(`.footer__statistics`);
const body = document.querySelector(`body`);
const sectionFilms = new _components_section_films_js__WEBPACK_IMPORTED_MODULE_3__["default"]();

main.innerHTML = `Loading...`;

api.getFilms().then((films) => {
  const mainOnDateChange = (actionType, update, old, unit, evt) => {
    return Object(_components_on_data_change_js__WEBPACK_IMPORTED_MODULE_5__["onDataChange"])(actionType, update, old, unit, evt, pageController, body);
  };

  main.innerHTML = ``;
  const pageController = new _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_1__["default"](body, main, films, false, mainOnDateChange, `all`);
  Object(_components_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(main, sectionFilms.getElement());
  pageController.initMain();

  footerCount.innerHTML = `<p>${films.length} movies inside</p>`;
});

const getSearch = new _controllers_search_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"](header, main);
